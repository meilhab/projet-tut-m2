...
\author{Catherine PINTO DOS SANTOS ALMEIDA\\Benoît MEILHAC  %rajouter un \\ au besoin
	\vspace{5mm}
}
...
\date{
	...
	\end{center}
	\vspace{5mm}
	\huge{\textbf{Transformation d'un diagramme de séquences SysML vers les automates d'interfaces et vérification de compatibilité avec l'outil Ticc}}\\
	\vspace{14mm}
	\normalsize{	
	Tuteurs :\\
        Mr MOUNTASSIR\\
