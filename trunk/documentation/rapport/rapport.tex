\documentclass[twoside, 11pt, a4paper, latin1, frenchb]{report}
\usepackage {babel}
...
\hypersetup{
    ...
    pdfauthor={Pinto Dos Santos Almeida Catherine, Meilhac Benoît},     % author
    pdfsubject={Transformation d'un diagramme de séquences SysML vers les automates d'interfaces et vérification de compatibilité avec l'outil Ticc},   % subject of the document
...
\author{
    Catherine PINTO DOS SANTOS ALMEIDA\\Benoît MEILHAC  %rajouter un \\ au besoin
	\vspace{5mm}
}
...
\date{
	...
	\end{center}
	\vspace{5mm}
	\huge{\textbf{Transformation de diagrammes de séquences SysML vers les automates d'interfaces et vérification de la compatibilité avec l'outil Ticc}}\\
	\vspace{14mm}
	\normalsize{	
	Tuteurs :\\
        Mr MOUNTASSIR\\
...
\input{ConstructionDSversTicc}

\input{VerificationComposant}

\input{Problemes}

\input{ConclusionPerspectives}
