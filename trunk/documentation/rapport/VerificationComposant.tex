...
Vérifier la compatibilité entre deux composants revient à vérifier la compatibilité entre leur deux automates d'interfaces respectif.

Pour ce faire, il faut commencer par vérifier que les deux automates sont composables, c'est à dire que leurs ensembles d'actions d'entrée, de sortie et internes sont disjoints.
