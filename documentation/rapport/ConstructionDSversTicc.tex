...
Le but principal du projet est, partant d'un diagramme de définition de blocs, de récupérer deux blocs interagissant ensemble et de pouvoir valider le fait qu'ils soient compatibles l'un avec l'autre.
