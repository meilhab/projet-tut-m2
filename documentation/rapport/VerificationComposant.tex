...
Pour vérifier la compatibilité des automates d'interfaces via l'outil Ticc~\cite{ticcDocumentation, siteTicc}, il faut lancer le fichier .in. Ce fichier réalise la composition des interfaces deux à deux et affiche le résultat.
