...
On peut remarquer dans l'exemple de la figure~\ref{Detecteur de Fumee} que les deux automates d'interfaces sont incompatibles car l'un produit un événement \enquote{FD!} alors que l'autre non.
